...
from n2s.core.enhancer.base import LlmContextEnhancer
from n2s.core.enhancer.default import DefaultLlmContextEnhancer
...
from n2s.core.llm.models import LlmMessage
...
class MockLlmService(LlmService):
    ...
    async def send_request(self, request):
        ...
        from n2s.core.llm.models import LlmResponse, LlmResponseMessage
    ...
    async def stream_request(self, request):
        ...
        from n2s.core.llm.models import LlmStreamChunk
