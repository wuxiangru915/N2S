...
export const WithConversation: Story = {
  ...
  render: (args) => {
    setTimeout(() => {
      const chat = document.querySelector('n2s-chat') as any;
...
export const MaxAutonomyMode: Story = {
  args: {
    title: 'N2S AI Agent - Max Autonomy',
...
export const WithRichComponents: Story = {
  args: {
    title: 'N2S AI Agent - Rich Components',
...
export const WithToolExecutionComponents: Story = {
  args: {
    title: 'N2S AI Agent - Tool Execution',
...
export const WithChart: Story = {
  args: {
    title: 'N2S AI Agent - Chart Display',
...
export const WithButtons: Story = {
  args: {
    title: 'N2S AI Agent - Button Components',
