...
import { n2sDesignTokens } from '../styles/n2s-design-tokens.js';
...
const ensureTokenStyles = () => {
  if (document.getElementById('n2s-token-style')) {
    return;
  }

  const style = document.createElement('style');
  style.id = 'n2s-token-style';
  style.textContent = n2sDesignTokens.cssText.replace(/:host/g, '.n2s-tokens');
  document.head.appendChild(style);
};

const ensureRichComponentStyles = () => {
  if (document.getElementById('n2s-rich-component-styles')) {
    return;
  }

  const style = document.createElement('style');
  style.id = 'n2s-rich-component-styles';
...
const createContainer = () => {
  ...
  container.className = 'n2s-tokens';
  container.style.cssText = `
    padding: var(--n2s-space-5, 20px);
    max-width: 1200px;
    margin: 0 auto;
    background: var(--n2s-background-default, #0b0f19);
    border-radius: var(--n2s-border-radius-lg, 8px);
    box-shadow: var(--n2s-shadow-md, 0 4px 6px rgba(0, 0, 0, 0.1));
    color: var(--n2s-foreground-default, #ffffff);
  `;
  ...
  additionalStyles.textContent = `
    ...
    .n2s-tokens {
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
    }

    .n2s-tokens .rich-dataframe {
      background: var(--n2s-background-default, #0b0f19) !important;
      border: 1px solid var(--n2s-outline-default, #333) !important;
      border-radius: var(--n2s-border-radius-lg, 8px) !important;
      overflow: hidden !important;
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
    }

    .n2s-tokens .dataframe-table {
      width: 100% !important;
      border-collapse: collapse !important;
      font-size: 0.875rem !important;
      color: var(--n2s-foreground-default, #ffffff) !important;
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
    }

    .n2s-tokens .dataframe-table th {
      background: var(--n2s-background-higher, #1a1f2e) !important;
      color: var(--n2s-foreground-default, #ffffff) !important;
      font-weight: 600 !important;
      text-align: left !important;
      padding: 12px 16px !important;
      border-bottom: 2px solid var(--n2s-outline-default, #333) !important;
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
    }

    .n2s-tokens .dataframe-table td {
      padding: 12px 16px !important;
      border-bottom: 1px solid var(--n2s-outline-dimmer, #222) !important;
      color: var(--n2s-foreground-default, #ffffff) !important;
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
    }

    .n2s-tokens .dataframe-table.striped tbody tr:nth-child(even) {
      background: rgba(255, 255, 255, 0.02) !important;
    }

    .n2s-tokens .dataframe-header {
      padding: 16px 20px !important;
      background: var(--n2s-background-higher, #1a1f2e) !important;
      border-bottom: 1px solid var(--n2s-outline-default, #333) !important;
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
    }

    .n2s-tokens .dataframe-title {
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
      color: var(--n2s-foreground-default, #ffffff) !important;
      font-weight: 600 !important;
    }

    .n2s-tokens .dataframe-description {
      font-family: var(--n2s-font-family-default, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif) !important;
      color: var(--n2s-foreground-dimmer, #b1bac4) !important;
    }

    .n2s-tokens .dataframe-actions {
