...
const addMockN2sChat = (container: HTMLElement) => {
  // Create a mock n2s-chat element with sendMessage method
  const mockN2sChat = document.createElement('div');
  mockN2sChat.setAttribute('id', 'mock-n2s-chat');

  // Store the original querySelector
  const originalQuerySelector = document.querySelector.bind(document);

  // Override querySelector to return our mock when looking for n2s-chat
  document.querySelector = function(selector: string) {
    if (selector === 'n2s-chat') {
      return mockN2sChat as any;
    }
    return originalQuerySelector(selector);
  } as any;

  // Add sendMessage method that logs to console and shows in UI
  (mockN2sChat as any).sendMessage = (message: string) => {
  ...
  container.appendChild(mockN2sChat);
  return mockN2sChat;
};
...
export const SingleButtons: Story = {
  render: () => {
    ...
    addMockN2sChat(container);

    // Add title
    const title = document.createElement('h2');
    title.textContent = 'Single Button Components';
    title.style.cssText = 'margin-bottom: 20px; color: var(--n2s-text-primary);';
    ...
    instruction.style.cssText = 'margin-top: 20px; color: var(--n2s-text-secondary); font-style: italic;';
...
export const ButtonGroups: Story = {
  render: () => {
    ...
    sectionTitle1.style.cssText = 'margin: 20px 0 10px 0; color: var(--n2s-text-primary); font-size: 16px;';
    ...
    sectionTitle2.style.cssText = 'margin: 20px 0 10px 0; color: var(--n2s-text-primary); font-size: 16px;';
    ...
    sectionTitle3.style.cssText = 'margin: 20px 0 10px 0; color: var(--n2s-text-primary); font-size: 16px;';
    ...
    sectionTitle4.style.cssText = 'margin: 20px 0 10px 0; color: var(--n2s-text-primary); font-size: 16px;';
    ...
    sectionTitle5.style.cssText = 'margin: 20px 0 10px 0; color: var(--n2s-text-primary); font-size: 16px;';
...
export const InteractiveDemo: Story = {
  render: () => {
    ...
    description.style.cssText = 'margin-bottom: 20px; color: var(--n2s-text-secondary);';
