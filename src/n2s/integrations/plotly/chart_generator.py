...
class PlotlyChartGenerator:
    ...
    # N2S brand colors from landing page
    THEME_COLORS = {
        "navy": "#023d60",
        "cream": "#e7e1cf",
        "teal": "#15a8a8",
    ...
    def _apply_standard_layout(self, fig: go.Figure) -> go.Figure:
        """Apply consistent N2S brand styling to all charts.

        Uses N2S brand colors from the landing page for a cohesive look.

        Args:
            fig: Plotly figure to update

        Returns:
            Updated figure with N2S brand styling
        """
        fig.update_layout(
            # paper_bgcolor='white',
            # plot_bgcolor='white',
            ...
            colorway=self.COLOR_PALETTE,  # Use N2S brand colors for data
    ...
    def _create_correlation_heatmap(
        ...
        # Custom N2S color scale: navy (negative) -> cream (neutral) -> teal (positive)
        n2s_colorscale = [
        ...
        fig = cast(
            ...
            px.imshow(
                ...
                x=columns,
                y=columns,
                color_continuous_scale=n2s_colorscale,
                zmin=-1,
                zmax=1,
            ),
        )
