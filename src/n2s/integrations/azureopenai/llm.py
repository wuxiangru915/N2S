...
class AzureOpenAILlmService(LlmService):
    ...
    Wraps `openai.AzureOpenAI` so N2S can talk to deployment-scoped models
    ...
    def __init__(
        ...
        **extra_client_kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "openai package is required. Install with: pip install 'n2s[azureopenai]' "
