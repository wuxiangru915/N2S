...
class DefaultWorkflowHandler(WorkflowHandler):
    ...
    async def get_starter_ui(
        ...
        if self.welcome_message:
            ...
            return [self._generate_starter_card(setup_analysis, is_admin, lang=lang)]

    def _generate_starter_card(
        self, analysis: Dict[str, Any], is_admin: bool, lang: str = "zh"
    ) -> UiComponent:
        ...
        if is_admin:
            ...
            return self._generate_admin_starter_card(analysis, lang=lang)
        else:
            # User view: simple welcome message
            return self._generate_user_starter_card(analysis, lang=lang)

    def _generate_admin_starter_card(
        self, analysis: Dict[str, Any], lang: str = "zh"
    ) -> UiComponent:
        ...
        if analysis["has_memory"]:
            ...
            actions.append(
                {
                    "label": "🧠 View Memories" if is_en else "🧠 查看记忆",
                    "action": "/memories",
                    "variant": "secondary",
                }
            )
    ...
    def _generate_user_starter_card(
        self, analysis: Dict[str, Any], lang: str = "zh"
    ) -> UiComponent:
    ...
    def _generate_setup_guidance(
        ...
        if not analysis["has_sql"]:
            ...
            content = (
                "## 🚨 Setup Required\n\n"
                "To get started with N2S, you need to configure a SQL connection tool:\n\n"
                "```python\n"
                "from n2s.tools import RunSqlTool\n\n"
            ...
            if not analysis["has_memory"]:
                suggestions.append(
                    ...
                    "```python\n"
                    "from n2s.tools import SearchSavedCorrectToolUses, SaveQuestionToolArgs\n"
            ...
            if not analysis["has_viz"]:
                suggestions.append(
                    ...
                    "```python\n"
                    "from n2s.tools import VisualizeDataTool\n"
    ...
    async def _generate_status_check(
        ...
        if analysis["is_complete"]:
            status_content += (
                "🎉 **Excellent!** Your N2S setup is complete and optimized.\n\n"
            )
