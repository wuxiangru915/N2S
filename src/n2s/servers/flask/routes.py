"""
Flask route implementations for N2S Agent.
"""
...
def register_chat_routes(
    ...
    def index() -> str:
        ...
        cdn_url = config.get("cdn_url", "https://img.n2s.ai/n2s-components.js")
    ...
    @app.route("/api/n2s/v2/chat_sse", methods=["POST"])
    ...
    @app.route("/api/n2s/v2/chat_websocket")
    ...
    @app.route("/api/n2s/v2/chat_poll", methods=["POST"])
