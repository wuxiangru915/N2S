#!/usr/bin/env python3
"""
Example demonstrating the artifact system in N2S Agent.
...
from n2s import Agent, UiComponent, User, AgentConfig
from n2s.core.rich_components import ArtifactComponent
from n2s.integrations.anthropic.mock import MockLlmService
from n2s.core.interfaces import Agent, LlmService
...
async def main() -> None:
    ...
    document.querySelector('n2s-chat').addEventListener('artifact-opened', (event) => {
