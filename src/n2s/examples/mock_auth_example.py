...
Usage:
    python -m n2s.examples.mock_auth_example
"""
...
def create_demo_agent() -> Agent:
    ...
    user_resolver = CookieEmailUserResolver(cookie_name="n2s_email")
...
async def demo_authentication():
    ...
    request_context = RequestContext(
        cookies={"n2s_email": "alice@example.com"},
        headers={},
    ...
    bob_context = RequestContext(
        cookies={"n2s_email": "bob@company.com"},
    ...
    print("• CookieEmailUserResolver extracts email from n2s_email cookie")
