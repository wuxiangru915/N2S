...
Usage:
  ...
  Interactive: python -m n2s.examples.mock_custom_tool
  REPL: from n2s.examples.mock_custom_tool import create_demo_agent
  Server: python -m n2s.servers --example mock_custom_tool
"""
