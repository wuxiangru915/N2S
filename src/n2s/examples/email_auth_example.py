"""
Email authentication example for the N2S Agent framework.
...
Interactive: python -m n2s.examples.email_auth_example
...
from n2s.core import Tool, UserService
from n2s.core import ToolContext, ToolResult
from n2s.core.registry import ToolRegistry
from n2s.core.components import UiComponent
from n2s.core import RichComponent
