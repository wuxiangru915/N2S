...
Run:
  PYTHONPATH=. python n2s/examples/openai_quickstart.py
"""
...
async def main() -> None:
    ...
    try:
        from n2s.integrations.anthropic import OpenAILlmService
    ...
    from n2s import AgentConfig, Agent, User
    from n2s.core.registry import ToolRegistry
    from n2s.tools import ListFilesTool
