...
Usage:
    PYTHONPATH=. python n2s/examples/evaluation_example.py
"""

import asyncio
from n2s import Agent, MockLlmService, MemoryConversationStore, User
...
async def main():
    ...
    print("\n🚀 N2S Agent Evaluation System Demo")
    print("=" * 80)
    ...
    print("=" * 80)
    print("\nKey Takeaways:")
    print("  1. Evaluations are integral to the N2S package")
