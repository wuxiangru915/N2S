"""
Mock quickstart example for the N2S Agent framework.
...
Usage:
  ...
  Interactive: python -m n2s.examples.mock_quickstart
  REPL: from n2s.examples.mock_quickstart import create_demo_agent
  Server: python -m n2s.servers --example mock_quickstart
"""
...
def create_demo_agent() -> Agent:
    ...
    llm_service = MockLlmService(
        response_content="Hello! I'm a helpful AI assistant created using the N2S Agent framework."
    )
...
def run_interactive() -> None:
    ...
    print("Starting N2S Agent mock quickstart demo...")
    asyncio.run(main())
